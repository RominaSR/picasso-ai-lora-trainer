...
## 📂 Project Files
- 📜 **Google Colab Notebook:** [`picasso_lora_trainer_xl_clean.ipynb`](https://github.com/RominaSR/picasso-ai-lora-trainer/blob/main/picasso_lora_trainer_xl_clean.ipynb)  
